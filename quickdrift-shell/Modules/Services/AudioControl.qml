...
Singleton {
    ...
    Connections {
        ...
        function onVolumeChanged() {
            ...
            if (!ThemeSettings.soundSettings.audioProtection)
                return;
            if (!lastReady) {
            ...
            const maxAllowedIncrease = ThemeSettings.soundSettings.audioMaxIncrease / 100;
            const maxAllowed = ThemeSettings.soundSettings.audioMaxVolume / 100;
