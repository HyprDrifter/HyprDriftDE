...
PopupWindow {
    ...
    color: "transparent"
    onVisibleChanged: { grabber.active = visible}
    ...
    ClippingRectangle {
        ...
        Component.onCompleted: mixerRect.implicitHeight = 1
        clip: true
        color: ThemeSettings.mantle
        visible: root.visible
        radius: Settings.taskbar.geometry.radius

        Binding { mixerRect.implicitHeight: container.implicitHeight }
        ...
        Behavior on implicitHeight {
            NumberAnimation {
                ...
                onRunningChanged: {
                    if(mixerRect.implicitHeight == 1 && !root.opened && root.visible) { root.visible = false}
                }
            }
        }
        ...
        ColumnLayout {
            ...
            implicitHeight: root.visible ?(mainView ? appView.implicitHeight + tabSelector.implicitHeight : devView.implicitHeight + tabSelector.implicitHeight): 1
            onImplicitHeightChanged: {
                mixerRect.implicitHeight = implicitHeight
            }
            onVisibleChanged: {mixerRect.implicitHeight = implicitHeight}
